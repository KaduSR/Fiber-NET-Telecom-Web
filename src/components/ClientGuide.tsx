      ...
      <div className="bg-fiber-card py-16 border-b border-white/5">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Tudo o que você precisa saber para aproveitar ao máximo a sua
            conexão Fiber.Net.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-20">
          ...
          <div className="flex flex-col lg:flex-row gap-10 items-center lg:items-start">
            <div className="flex-1">
              ...
              <p className="text-gray-400 mb-6 leading-relaxed">
                Nossa fatura foi desenhada para ser simples e transparente. Veja
                os principais pontos de atenção para identificar seus dados e
                valores.
              </p>
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <span className="text-gray-500 text-sm">
                      Fique atento à data de vencimento para evitar bloqueios
                      automáticos.
                    </span>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <span className="text-gray-500 text-sm">
                      Confira sempre se o beneficiário é a{" "}
                      <strong>FIBER.NET - TELECOM FIBER NET LTDA</strong>.
                    </span>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <span className="text-gray-500 text-sm">
                      Use o QR Code no corpo do boleto para baixa imediata do
                      pagamento.
                    </span>
                  </div>
                </li>
              ...
              <div className="mt-8">
                <Button variant="outline" onClick={handleSegundaVia}>
                  Solicitar 2ª Via
                </Button>
              </div>
            </div>
            ...
            <div className="w-full max-w-md bg-white text-black text-[10px] font-sans p-4 rounded shadow-2xl border border-gray-200 select-none transform hover:scale-105 transition-transform duration-300 origin-top">
              ...
              <div className="flex items-center border-b-2 border-gray-800 pb-1 mb-1">
                <div className="flex items-center gap-1 pr-4 border-r-2 border-gray-800">
                  ...
                  <span className="font-bold text-lg tracking-tighter text-[#003641]">
                    SICOOB
                  </span>
                </div>
                <div className="px-4 text-xl font-bold border-r-2 border-gray-800">
                  756
                </div>
              ...
              <div className="grid grid-cols-4 border border-gray-400">
                ...
                <div className="col-span-3 border-r border-b border-gray-400 p-1">
                  <div className="text-[8px] text-gray-600 uppercase tracking-tight">
                    Local de Pagamento
                  </div>
                  <div className="font-bold text-[10px]">
                    Pagar preferencialmente no banco emitente
                  </div>
                </div>
                ...
                <div className="col-span-3 border-r border-b border-gray-400 p-1">
                  ...
                  <div className="font-bold text-[10px]">
                    FIBER.NET - 22.969.088/0001-97
                  </div>
                  <div className="text-[8px] text-gray-500 truncate">
                    ROD RJ 145, 53320, ELIZABETH - Rio das Flores/RJ - 27660-000
                  </div>
                </div>
                ...
                <div className="col-span-3 border-r border-gray-400 p-1 min-h-[120px] relative">
                  ...
                  <div className="font-bold text-[10px] mb-4">
                    Após vencimento multa R$ 1,80.
                  </div>
              ...
              <div className="mt-3 h-10 sm:h-12 flex items-end gap-px overflow-hidden px-2">
                <div className="text-[8px] text-gray-400 absolute right-8 -mt-3">
                  Autenticação Mecânica
                </div>
                {[...Array(55)].map((_, i) => (
                  <div
                    key={i}
                    className={`bg-black h-full w-0.5 sm:w-1 flex-shrink-0 ${Math.random() > 0.4 ? "opacity-100" : "opacity-0"}`}
                    style={{ height: Math.random() > 0.5 ? "100%" : "60%" }}
                  ></div>
                ))}
              </div>
            </div>
        ...
        <section>
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-2xl font-bold text-white">
              Dicas para um Wi-Fi Turbinado
            </h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-fiber-card p-6 rounded-xl border border-white/10">
              <div className="mb-4 text-fiber-orange">
                <Router />
              </div>
              <h3 className="text-white font-bold mb-2">Posicionamento</h3>
              <p className="text-sm text-gray-400">
                O roteador deve ficar em local alto e central na casa. Evite
                escondê-lo em gavetas, atrás de TVs ou espelhos, pois isso
                bloqueia o sinal.
              </p>
            </div>
            <div className="bg-fiber-card p-6 rounded-xl border border-white/10">
              ...
              <p className="text-sm text-gray-400">
                Micro-ondas, babás eletrônicas e telefones sem fio podem
                interferir no sinal. Mantenha o roteador afastado desses
                aparelhos.
              </p>
            </div>
            <div className="bg-fiber-card p-6 rounded-xl border border-white/10">
              ...
              <p className="text-sm text-gray-400">
                Use a rede <strong>5GHz</strong> para velocidade máxima perto do
                roteador, e a rede <strong>2.4GHz</strong> para maior alcance em
                cômodos distantes.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div>
              ...
              <p className="text-gray-400 mb-4">
                Sua segurança é nossa prioridade. A rede da Fiber.Net conta com
                proteção contra ataques externos, mas você também pode fazer a
                sua parte:
              </p>
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm text-gray-300">
                <li className="flex items-center">
                  <div className="w-2 h-2 bg-fiber-green rounded-full mr-2"></div>
                  Não compartilhe sua senha do Wi-Fi com desconhecidos.
                </li>
                <li className="flex items-center">
                  <div className="w-2 h-2 bg-fiber-green rounded-full mr-2"></div>
