      ...
      <div className="bg-fiber-card py-16 border-b border-white/5">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">
            ...
            <span className="text-fiber-blue">Privacidade</span>
          </h1>
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Transparência total sobre como protegemos seus dados e operamos de
            acordo com a LGPD e regulamentações da ANATEL.
          </p>
        </div>
      </div>
        ...
        <div className="bg-neutral-900 border border-fiber-blue/30 rounded-xl p-6 mb-12 flex flex-col md:flex-row items-center gap-6 shadow-lg shadow-fiber-blue/5">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-gray-400 text-sm mb-3">
              Para exercer seus direitos de titular (acesso, correção ou
              exclusão de dados), entre em contato com nosso encarregado de
              proteção de dados.
            </p>
            ...
            {activeSection === "lgpd" && (
              <div className="p-6 pt-0 border-t border-white/5 bg-neutral-900/50">
                <div className="prose prose-invert max-w-none text-sm text-gray-400 leading-relaxed space-y-4 pt-4">
                  <p>
                    A Fiber.Net Telecom coleta e trata dados pessoais com a
                    finalidade exclusiva de prestar serviços de
                    telecomunicações, emitir faturas e cumprir obrigações
                    legais.
                  </p>
                  ...
                  <ul className="list-disc pl-5 space-y-1">
                    <li>
                      ...
                      Você pode solicitar saber quais dados temos sobre você.
                    </li>
                    <li>
                      <strong className="text-gray-300">Correção:</strong>{" "}
                      Solicitar a atualização de dados incorretos ou
                      desatualizados.
                    </li>
                    <li>
                      <strong className="text-gray-300">Portabilidade:</strong>{" "}
                      Transferir seus dados para outro fornecedor de serviço.
                    </li>
                    <li>
                      <strong className="text-gray-300">Eliminação:</strong>{" "}
                      Solicitar a exclusão de dados (exceto os necessários para
                      cumprimento legal/fiscal).
                    </li>
                  </ul>
                  <h4 className="text-white font-bold">Coleta de Dados:</h4>
                  <p>
                    Coletamos: Nome completo, CPF/CNPJ, Endereço, Telefone,
                    E-mail e Logs de Conexão (obrigatório pelo Marco Civil da
          ...
          <div className="bg-fiber-card border border-white/10 rounded-xl overflow-hidden transition-all duration-300">
            ...
            {activeSection === "marco" && (
              <div className="p-6 pt-0 border-t border-white/5 bg-neutral-900/50">
                <div className="prose prose-invert max-w-none text-sm text-gray-400 leading-relaxed space-y-4 pt-4">
                  <p>
                    Em conformidade com a Lei 12.965/14, a Fiber.Net respeita a{" "}
                    <strong>neutralidade da rede</strong>, tratando todo pacote
                    de dados de forma isonômica, sem distinção por conteúdo,
                    origem, destino ou serviço.
                  </p>
                  <p>
                    Somos obrigados por lei a manter os registros de conexão
                    (Data, Hora de Início/Fim e IP) pelo prazo de{" "}
                    <strong>1 ano</strong>, em ambiente controlado e seguro.
                    Estes dados só são disponibilizados mediante ordem judicial.
                  </p>
                </div>
              </div>
            )}
          ...
          <div className="bg-fiber-card border border-white/10 rounded-xl overflow-hidden transition-all duration-300">
            ...
            {activeSection === "scm" && (
              <div className="p-6 pt-0 border-t border-white/5 bg-neutral-900/50">
                <div className="prose prose-invert max-w-none text-sm text-gray-400 leading-relaxed space-y-4 pt-4">
                  <p>
                    A TELECOM FIBER NET LTDA (CNPJ 22.969.088/0001-97) é uma
                    empresa devidamente outorgada pela Agência Nacional de
                    Telecomunicações (ANATEL) para prestar o Serviço de
                  ...
                  <div className="flex items-start gap-3 p-3 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
                    ...
                    <p className="text-xs text-yellow-100">
                      Central de Atendimento ANATEL: 1331 (Funciona de segunda a
                      sexta, das 8h às 20h).
                    </p>
                  </div>
                  <p>
                    O Contrato de Prestação de Serviços e o Plano de Serviço
                    aderido pelo assinante encontram-se registrados e
                    disponíveis para consulta abaixo.
                  </p>
                </div>
              </div>
            )}
